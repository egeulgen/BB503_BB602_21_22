...
Suppose we are performing an RNA array experiment that targets 20000 genes in total. We find that 75 genes are important (e.g., deferentially expressed between tumors vs. controls). We find that 60 of the important genes are in a functional gene set (e.g., Cell cycle) of 1000 genes.
